...
@section('content')
    ...
    <div class="panel panel-primary">
        ...
        <div class="list-group">
            ...
            @endif
            @if ($question->questionrestriction || $question->optiongroup)
                <div class="list-group-item">
                    <div class="list-group-item-heading"><h4>{{ trans('pagestrings.question_parameter') }}</h4></div>
                    <div class="list-group-item-text">
                        @if ($question->questionrestriction && ($question->questionrestriction->min_numeric || $question->questionrestriction->max_numeric || $question->questionrestriction->step_numeric))
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        @if($question->questionrestriction->min_numeric)
                                    ...
                                    <div class="col-md-4">
                                        @if($question->questionrestriction->max_numeric)
                                    ...
                                    <div class="col-md-4">
                                        @if($question->questionrestriction->step_numeric)
                        ...
                        @endif
                        @if ($question->questiontype->code == "SINGLECHOICE" || $question->questiontype->code == 'MULTICHOICE')
                            <div class="row">
                                <div class="col-md-12">
                                    @if ($question->questiontype->code == 'MULTICHOICE')
                                        <div class="col-md-3">
                                            <div class="row"><strong>{{ trans('pagestrings.question_min_integer') }}</strong></div>
                                            <div class="row">{{ $question->questionrestriction->min_integer ? $question->questionrestriction->min_integer: '0' }}</div>
                                        </div>
                                        <div class="col-md-3">
    ...
    <div class="list-group-item">
        <div class="list-group-item-text">
            <div class="row">
                ...
                <div class="col-md-6 text-right"><a class="btn btn-primary" href="{{route('studies.substudies.questiongroups.questions.edit', [$question->questiongroup->substudy->study->id,  $question->questiongroup->substudy->id_in_study, $question->questiongroup->id_in_substudy, $question->id_in_questiongroup])}}"><i class="icon-plus-sign"></i>  {{ trans('pagestrings.substudies_rmenu_editquestion') }}</a></div>
            </div>
        </div>
    </div>
    @endif
