...
@section('sidebar')
    ...
    <h3 >{{ HTML::linkRoute('studies.substudies.questiongroups.questions.show', trans('pagestrings.substudies_rmenu_showquestion'), [$question->questiongroup->substudy->study->id,  $question->questiongroup->substudy->id, $question->questiongroup->id, $question->id])}}</h3>
@stop
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @if (!($question->optiongroup->is_predefined))
                                    <div class="col-md-6">
                                        <div class="row"><strong>{{ trans('pagestrings.question_selfdef_values') }}</strong></div>
                                        <table class="table">
                                            <thead>
                                            <tr>
