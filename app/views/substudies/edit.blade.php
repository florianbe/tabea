                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group hidable">
                            ...
                            <input type="number"  step="1" class="form-control" name="intervaltime" id="interavaltime" value={{$substudy->trigger_time_interval}}>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('.datetimepicker').datetimepicker({
                pickTime: true,
                minDate: '{{ $substudy->study->accessible_from->format('d/m/Y H:i:s') }}',
                maxDate: '{{ $substudy->study->accessible_until->format('d/m/Y H:i:s') }}',
        ...
        $(document).ready(function()
        {
            ...
            {
                $('.hidable').show();
                $('#intervaltime').attr('min', 1);
            }
            else
            {
                $('.hidable').hide();
                $('#intervaltime').attr('min', 0);
            }
