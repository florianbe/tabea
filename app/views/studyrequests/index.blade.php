...
@section('content') 
    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
            <td>{{ Form::model($study_request, ['route' => ['requests.destroy', $study_request->id], 'method' => 'DELETE']) }}<button type="submit" class="btn btn-link "><i class="fa fa-times fa-lg" style="color: red"></i></button>
                  {{Form::close()}}
            </td>
